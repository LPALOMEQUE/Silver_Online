...
<body>
                ...
                <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-7">
                      ...
                      <div class="row">
                        <input type="text" class="form-control" id="txtId" value="<?php echo $category[0] ?>" required>
  ...
  $(document).ready(function(){
    ...
    //
    //   id= $('#txtId').val();
    //   Name_art= $('#txtName_art').val();
    //   Price_art= $('#txtPrice_art').val();
    //   Url_art= $('#txtUrl_art').val();
    //
    //     AddCart(id, Name_art, Price_art, Url_art);
    //
    // });
